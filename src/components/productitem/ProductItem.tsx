...
function ProductItem ( { image,description , price,category , rating , title} : TproductsItem ) {
  return (
      ...
      >
        ...
        <div className="relative w-full aspect-square overflow-hidden bg-[#f7f3ee]">
          ...
          <div className="absolute bottom-1  left-4  bg-white rounded-2xl shadow-[0_6px_16px_-4px_rgba(43,36,32,0.15)] px-3 py-2 flex items-center gap-1.5">
            ...
            <span className="text-xs font-semibold text-[#2b2420]">{rating.rate}</span>
          </div>
        </div>
        ...
        {description}
          ...
          <div className="flex items-center justify-between mt-4">
            <span className="text-lg sm:text-xl font-bold text-[#2b2420]">${price}</span>
